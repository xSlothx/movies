...
SET ANSI_PADDING ON
GO
CREATE TABLE [dbo].[SH_InsertTable] (
...
GO
CREATE NONCLUSTERED INDEX [insertidx]
	ON [dbo].[SH_InsertTable] ([Project_Number], [ProductID])
	ON [PRIMARY]
GO
ALTER TABLE [dbo].[SH_InsertTable] SET (LOCK_ESCALATION = TABLE)
GO
